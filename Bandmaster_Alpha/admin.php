...
<html lang="en">
  <head>
    ...
    <!--
      ...
      This file is shown when there is a failure to log in.
    -->
...
<html ng-app="bandmaster">
    <head>
        <title>Bandmaster Dashboard</title>
        <meta charset="UTF-8">
        <!-- 
          admin.php

          This file serves as the administrator dashboard for users
          to modify their band page, upload songs and files, and add
          and remove new tasks.
        -->
    ...
    <body id="mainbody" ng-controller="bandmasterCtrl" ng-init='load()'>
        ...
        <div class="container-fluid" style="padding-top: 60px;">
            ...
            <h1 style="text-align: center;" id="bandname">{{bandname}}</h1>
            <div style="text-align: center;">
              <button id="changeNameButton" onclick="showChangeName()" style="background-color: #DDDDDD;">Click to Edit</button>
                <form id="changeNameBox" class="hidden">
                    <input id="nameInput" type="text" name="nameInput" value="{{bandname}}"><br>
                    <input type="button" ng-click="changeName()" value="Save">
                    <input type="button" onclick="closeChangeName()" value="Cancel">
                </form>
            </div>
            ...
            <div class="col-md-4" id="setlist" >
                ...
                <div id="tableDiv">
                    ...
                    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li><a href="#incompleteSongs" data-toggle="tab">Incomplete Songs</a></li>
                    </ul>
                    <div id="my-tab-content" class="tab-content">
                        ...
                        <div class="tab-pane" id="sheetMusic">
                            <h1>#sheetMusic listing</h1>
                        </div>
                        <div class="tab-pane" id="downloads">
                            <h1>#downloads listing</h1>
                        </div>
                        <div class="tab-pane" id="incompleteSongs">
                            <h1>#incompleteSongs listing</h1>
                        </div>
                    </div>
