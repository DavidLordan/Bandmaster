...
bandmaster.controller("bandmasterCtrl", function ($scope, $http) {
  ...
  */
  $scope.updateActive = function (i) {
    ...
    if ($scope.currentSongList === "songs") {
      ...
      if ($scope.activeSong !== i) {
        ...
        $("#infoTable").append("<tr><td>Song File</td><td><a href='uploads/" + songname + "' target='_blank'>Download</a></td></tr>");
        if (lyrics != undefined) {
          $("#infoTable").append("<tr><td>Lyrics</td><td><a href='uploads/" + lyrics + "' target='_blank'>Download</a></td></tr>");
        }
        if (sheetmusic != undefined) {
          $("#infoTable").append("<tr><td>Sheet Music</td><td><a href='uploads/" + sheetmusic + "' target='_blank'>Download</a></td></tr>");
        } 
        if (guitartabs != undefined) {
          $("#infoTable").append("<tr><td>Guitar Tabs</td><td><a href='uploads/" + guitartabs + "' target='_blank'>Download</a></td></tr>");
        }
      }
      // otherwise deselect the song
      else {
        $scope.activeSong = "";
        $scope.audioActive = "";
  ...
  //inner a download of a zip file of the appropriate song.
  ...
  */
  ...
  $http.get('JSON/settings.json').success(function (data) {
    console.log("Fetching settings");
    $scope.bandname = data.bandname;
  });

  /*
    updateSongs will fetch the songs.json songs and
    update the UI song list
  */
  ...
  /*
    updateTasks will fetch the taskList.json tasks and
    update the UI task list
  */
  ...
  */
  ...
  /*
    removeActiveTask will remove the currently selected
    task.
  */
